                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-slate-50/70 border-b border-slate-100">
                                    ...
                                    <th class="p-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Nama Mata Pelajaran</th>
                            ...
                            <tbody class="divide-y divide-slate-100 text-sm text-slate-700 font-medium">
                                ...
                                <tr class="hover:bg-slate-50/40 transition-colors">
                                    ...
                                    <td class="p-4 text-slate-500 font-mono text-xs"><?= $row['kode_mapel']; ?></td>
