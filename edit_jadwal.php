...
if (isset($_POST['update_jadwal'])) {
    ...
    if (mysqli_num_rows($cek_bentrok) > 0) {
        $pesan_error = "⚠️ Gagal Update! Guru atau Ruang Kelas tersebut sudah memiliki jadwal lain di hari dan jam yang sama.";
    } else {
        ...
        <div class="flex-1 min-w-0 h-screen overflow-y-auto bg-slate-50/30">
            <div class="p-6 md:p-10 max-w-[800px] mx-auto space-y-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-xl font-extrabold text-slate-900">Perbarui Sesi Jadwal</h2>
