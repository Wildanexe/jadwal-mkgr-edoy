...
<head>
    ...
    <title>Data Kelas - SMAS MKGR Sepatan</title>
...
<body class="h-full antialiased text-slate-800 bg-slate-50/50">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 min-w-0 h-screen overflow-y-auto bg-slate-50/30">
            <div class="p-6 md:p-10 space-y-6 max-w-[1000px] mx-auto">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-1">Daftar registrasi rombongan belajar (Rombel) SMAS MKGR Sepatan.</p>
                    </div>
                    <div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-slate-50/70 border-b border-slate-100">
                                    ...
                                    <th class="p-4 text-[11px] font-bold text-slate-500 uppercase tracking-wider">Nama Rombel / Kelas</th>
                            ...
                            <tbody class="divide-y divide-slate-100 text-sm text-slate-700 font-medium">
                                ...
                                <tr class="hover:bg-slate-50/40 transition-colors">
                                    ...
                                    <td class="p-4 text-slate-900 font-bold tracking-tight"><?= $row['nama_kelas']; ?></td>
                                    <td class="p-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <a href="edit_kelas.php?id=<?= $row['id']; ?>" class="p-2 text-slate-500 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                            </a>
                                            <a href="hapus_kelas.php?id=<?= $row['id']; ?>" onclick="return confirm('Hapus kelas ini?')" class="p-2 text-slate-500 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-all">
                                ...
                                <tr>
                                    <td colspan="3" class="p-8 text-center text-slate-400 font-normal">Belum ada data kelas di database.</td>
                                </tr>
                                <?php endif; ?>
